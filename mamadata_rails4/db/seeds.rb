...
#b1 	= Benefit.find_or_create_by(category: "none",name: "Microcredit", description: "Income Generation Programm")
...
if User.count == 0
  # global admin
  User.create(email: "admin@sharana.org", 		password: "Uttapam", 		password_confirmation: "Uttapam", 	role: "admin").save!(:validate => false)

  # sharana users
  User.create(email: "rajkala@sharana.org", password: "goodluck", password_confirmation: "goodluck", role: "admin").save!(:validate => false)
  User.create(email: "murugaiyan@sharana.org", password: "goodluck", password_confirmation: "goodluck", role: "admin").save!(:validate => false)
  User.create(email: "bhuvana.r@sharana.org", password: "goodluck", password_confirmation: "goodluck", role: "accountant").save!(:validate => false)
  User.create(email: "kaladevimoorthee11@gmail.com", password: "goodluck", password_confirmation: "goodluck", role: "accountant").save!(:validate => false)
  User.create(email: "vetrivelan@sharana.org", password: "goodluck", password_confirmation: "goodluck", role: "social_worker").save!(:validate => false)
  User.create(email: "raymond.remo2@yahoo.com", password: "goodluck", password_confirmation: "goodluck", role: "social_worker").save!(:validate => false)
  User.create(email: "janbu2010@gmail.com", password: "goodluck", password_confirmation: "goodluck", role: "social_worker").save!(:validate => false)
  User.create(email: "ravianandpy@gmail.com", password: "goodluck", password_confirmation: "goodluck", role: "social_worker").save!(:validate => false)
  User.create(email: "amalakwspondy@gmail.com", password: "goodluck", password_confirmation: "goodluck", role: "social_worker").save!(:validate => false)
  User.create(email: "vadivurajendran@gmail.com", password: "goodluck", password_confirmation: "goodluck", role: "social_worker").save!(:validate => false)
  User.create(email: "coordinator@sharana.org", password: "goodluck", password_confirmation: "goodluck", role: "admin").save!(:validate => false)

  # tech team
  User.create(email: "pkabel@kabel.de", password: "goodluck", password_confirmation: "goodluck", role: "admin").save!(:validate => false)
  User.create(email: "yannick.schuchmann@googlemail.com", password: "goodluck", password_confirmation: "goodluck", role: "admin").save!(:validate => false)
  User.create(email: "jonasdanu.bekas@haw-hamburg.de", password: "goodluck", password_confirmation: "goodluck", role: "admin").save!(:validate => false)
  User.create(email: "dariusch.ochlast@gmail.com", password: "goodluck", password_confirmation: "goodluck", role: "admin").save!(:validate => false)
