...
Program.create(name: "Sponsorship", description: "")
Program.create(name: "Evening Homework Help Centre", description: "")
Program.create(name: "Day Care Centre", description: "")
Program.create(name: "Mobile Library", description: "")
Program.create(name: "Outreach Program", description: "")
Program.create(name: "Girls' Program", description: "")
Program.create(name: "Spirulina", description: "")
Program.create(name: "VTC", description: "")
Program.create(name: "Community Development", description: "")
Program.create(name: "Creches", description: "")
