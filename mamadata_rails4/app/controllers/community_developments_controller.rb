class CommunityDevelopmentsController < ApplicationController
  before_action :set_community_development, only: [:show, :edit, :update, :destroy]
  ...
  # GET /community_developments/1
  # GET /community_developments/1.json
  def show
  end

  # GET /community_developments/new
  def new
    @community_development = CommunityDevelopment.new
  end
  ...
  def create
    ...
    respond_to do |format|
      if @community_development.save
        format.html { redirect_to @community_development, notice: 'Community development was successfully created.' }
